            ...
            <div className="max-w-[1440px] mx-auto">
              <div className="flex flex-col lg:flex-row items-center align-center overflow-hidden h-96">
                <div>
                  ...
                  <br />
                  <p className="text-xl text-black text-center lg:text-left">Don't forget to grab yourself a drink along with some desert with your delicious meal.</p>
                </div>
                <div className="pt-3 lg">
                  <Image alt="" className="mask lg:mask-parallelogram-2" src={Drinks} width={0} height={0} />
                </div>
              </div>
            </div>
          </div>
